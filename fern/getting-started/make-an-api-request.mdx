...
FFmpeg isn't strictly required, but it's useful for a variety of tasks (such as converting between formats), so we suggest installing it. You may need to install FFmpeg separately:
