...
<figure>
    <img src="/images/concepts_continuations_without_continuations.png" alt="no_continuations" />
...
<audio controls src="/audio/concepts_continuations_without_continuations.wav">
...
<figure>
    <img src="/images/concepts_continuations_with_continuations.png" alt="continuations" />
...
<audio controls src="/audio/concepts_continuations_with_continuations.wav">
  Your browser does not support the audio element.
</audio>
...
You'll notice in Figure 2 that there's an `Audio N...` section in the output audio as well. This is because continuations allows you to change any N inputs together for a coherent audio output.

### What if I want to stream in word by word?

![](/images/concepts_continuations_multiple_inputs.png)
