...
description: >-
  Tips and tricks for better instant voice cloning with Sonic
slug: user-guides/voice-cloning
---
...
6. **Speak in the target language.** For instance, if you want the cloned voice to speak Spanish, speak Spanish in the recording.
