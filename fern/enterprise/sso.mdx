...
3. Follow steps 2, 3, 4, and 5 in [the Clerk SSO guide](https://clerk.com/docs/authentication/saml/okta), and send us the metadata URL you get from step 6.1.

After you are done, we will complete the remaining SSO setup andsend you a confirmation that SSO is enabled for your organization.
